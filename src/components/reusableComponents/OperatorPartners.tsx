...
const OperatorPartners: React.FC = () => (
  <section className="bg-[#181A29] md:py-16 px-2">
    <div className="max-w-5xl mx-auto">
      <h2 className="text-2xl md:text-4xl font-extrabold text-white text-center mb-2 uppercase tracking-wide">
        OPERATOR PARTNERS
      </h2>
      <p className="text-white/80 text-center mb-10 max-w-2xl mx-auto text-sm md:text-base">
        We Supply Player-Favourite Content To Online Casino Operators In
