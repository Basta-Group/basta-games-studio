        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          ...
          <div className="flex flex-col space-y-4 ">
            ...
            <p className="text-gray-400 text-sm font-bold">
              REVOLUTIONIZING IGAMING SINCE 2018
            </p>
            ...
            <div className="flex flex-col space-y-1">
              <a
                href="mailto:sales@jumpingplay.com"
              ...
              >
                ...
                <span>SALES@JUMPINGPLAY.COM</span>
              </a>
              <a
                href="mailto:info@jumpingplay.com"
                className="text-gray-400 text-sm flex items-center space-x-2 hover:text-blue-400 transition-colors"
              >
                <svg
                  className="h-5 w-5 text-gray-400"
                ...
                <span>INFO@JUMPINGPLAY.COM</span>
              </a>
            </div>
          </div>
